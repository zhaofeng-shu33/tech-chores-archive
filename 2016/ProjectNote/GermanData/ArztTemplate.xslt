...
<html>
	...
	<a href="sound://p008__001776626.spx" >
	 <img src="source/snd_sfx.png" style="margin-bottom:-2px" border="0" ></img>
	</a>
	...
	<xsl:if test="count(Kollokationen) &gt; 0">
	...
	<xsl:if test="count(zusammengesetzteWörter/KompositaCollection) &gt; 0">	
	...
	<xsl:if test="count(zusammengesetzteWörter/abgeleiteteWörter) &gt; 0">
    <table width="100%" border="0" bgcolor="#047DB1">
	...
	<xsl:if test="count(Synonymegruppe) &gt; 0">
	<table width="100%" border="0" bgcolor="#047DB1">
	...
	<xsl:if test="count(Antonymegruppe) &gt; 0">
	<table width="100%" border="0" bgcolor="#047DB1">
